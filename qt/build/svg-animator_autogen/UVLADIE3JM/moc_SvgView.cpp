...
QT_MOC_LITERAL(1, 8, 15), // "elementSelected"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "index"
QT_MOC_LITERAL(4, 31, 15), // "elementsChanged"
QT_MOC_LITERAL(5, 47, 14), // "historyChanged"
QT_MOC_LITERAL(6, 62, 6) // "fitSvg"

    },
    "SvgView\0elementSelected\0\0index\0"
    "elementsChanged\0historyChanged\0fitSvg"
};
...
void SvgView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->elementSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->elementsChanged(); break;
        case 2: _t->historyChanged(); break;
        case 3: _t->fitSvg(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SvgView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvgView::elementSelected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvgView::elementsChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SvgView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvgView::historyChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SvgView::elementSelected(int _t1)
{
...
// SIGNAL 1
void SvgView::elementsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SvgView::historyChanged()
{
